    ...
    <div className="min-h-screen px-6 py-12 max-w-7xl mx-auto flex flex-col">
      ...
      {cartItems.length === 0 ? (
        <div className="flex flex-col items-center justify-center py-20 text-center">
          <div className="w-24 h-24 bg-[#111] rounded-full flex items-center justify-center mb-6 border border-white/5">
                ...
                <div className="flex-1 w-full">
                  <div className="flex justify-between items-start mb-2">
                    <div>
                      ...
                      <p className="text-sm text-[#caa161] uppercase tracking-wider font-semibold">{item.category}</p>
                    </div>
                    <p className="text-xl font-bold text-white">${(item.price * item.quantity).toFixed(2)}</p>
                  </div>
                  
                  <div className="flex items-center justify-between mt-6">
                    <div className="flex items-center gap-4 bg-[#111] rounded-xl p-2 border border-white/5">
                      <button 
                    ...
                    <button 
                      ...
                      className="flex items-center gap-2 text-sm text-gray-400 hover:text-red-400 transition-colors bg-white/5 px-4 py-2 rounded-xl"
                    >
          ...
          <div className="lg:col-span-1">
            <div className="glass p-8 rounded-3xl border border-white/5 sticky top-24">
              ...
              <div className="space-y-4 mb-6 text-gray-300">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="text-white font-medium">
                    {shipping === 0 ? <span className="text-[#caa161]">Free</span> : `$${shipping.toFixed(2)}`}
                  </span>
                </div>
              </div>
              ...
              <div className="border-t border-white/10 pt-6 mb-8 flex justify-between items-center">
                ...
                <span className="text-3xl font-extrabold text-[#caa161]">${finalTotal.toFixed(2)}</span>
              </div>
              
              <button className="w-full py-4 bg-gradient-to-r from-[#caa161] to-[#b08a50] hover:from-[#b08a50] hover:to-[#9a7638] text-white rounded-xl font-bold text-lg transition-all shadow-lg shadow-[#caa161]/20 flex items-center justify-center gap-2">
